...
# We use `move_to_configuration([...])` if we know the joints angles
# We use `move_to_configuration(position, quat_xyzw)` if we know where the end-effector should be (position)
...
class PickAndPlace(Node):
    def __init__(self):
        ...
        self.moveit2.max_acceleration = 0.7
    ...
    def coords_callback(self, msg):
        ...
        try:
            ...
            if color_id == self.target_color:
                ...
                quat_xyzw = [0.0, 1.0, 0.0, 0.0] # 180° around Y-axis
